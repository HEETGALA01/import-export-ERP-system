...
import { FiPlus, FiEdit2, FiEye, FiFilter, FiDownload, FiFileText } from 'react-icons/fi'
...
const SalesOrders = () => {
  ...
  const [orders, setOrders] = useState([
    ...
    { id: 'SO-1238', customer: 'Pacific Imports LLC', country: 'Australia', amount: '₹18,90,000', products: 'Electronics', quantity: 650, status: 'Shipped', date: '2026-01-12', deliveryDate: '2026-01-19' },
    { id: 'SO-1239', customer: 'Nordic Trading AS', country: 'Norway', amount: '₹9,25,000', products: 'Raw Materials', quantity: 400, status: 'Confirmed', date: '2026-01-14', deliveryDate: '2026-01-21' },
    { id: 'SO-1240', customer: 'Asian Commerce Group', country: 'Singapore', amount: '₹22,30,000', products: 'Machinery', quantity: 280, status: 'Shipped', date: '2026-01-10', deliveryDate: '2026-01-17' },
    { id: 'SO-1241', customer: 'Middle East Imports', country: 'UAE', amount: '₹26,40,000', products: 'Electronics', quantity: 820, status: 'Invoiced', date: '2026-01-11', deliveryDate: '2026-01-18' },
    { id: 'SO-1242', customer: 'Alpine Industries', country: 'Switzerland', amount: '₹19,50,000', products: 'Chemicals', quantity: 550, status: 'Confirmed', date: '2026-01-13', deliveryDate: '2026-01-20' },
    { id: 'SO-1243', customer: 'Dutch Import Corporation', country: 'Netherlands', amount: '₹21,40,000', products: 'Electronics', quantity: 720, status: 'Shipped', date: '2026-01-09', deliveryDate: '2026-01-16' },
    { id: 'SO-1244', customer: 'Italian Fashion Group', country: 'Italy', amount: '₹17,30,000', products: 'Textiles', quantity: 890, status: 'Invoiced', date: '2026-01-11', deliveryDate: '2026-01-18' },
    { id: 'SO-1245', customer: 'Swedish Industrial AB', country: 'Sweden', amount: '₹19,80,000', products: 'Machinery', quantity: 310, status: 'Confirmed', date: '2026-01-14', deliveryDate: '2026-01-21' },
    { id: 'SO-1246', customer: 'New Zealand Imports Ltd', country: 'New Zealand', amount: '₹15,70,000', products: 'Raw Materials', quantity: 620, status: 'Shipped', date: '2026-01-08', deliveryDate: '2026-01-15' },
    { id: 'SO-1247', customer: 'Irish Business Solutions', country: 'Ireland', amount: '₹16,20,000', products: 'Electronics', quantity: 480, status: 'Confirmed', date: '2026-01-16', deliveryDate: '2026-01-23' },
    { id: 'SO-1248', customer: 'Danish Trading Company', country: 'Denmark', amount: '₹18,50,000', products: 'Machinery', quantity: 390, status: 'Invoiced', date: '2026-01-12', deliveryDate: '2026-01-19' },
    { id: 'SO-1249', customer: 'Chilean Export Corp', country: 'Chile', amount: '₹13,60,000', products: 'Chemicals', quantity: 540, status: 'Draft', date: '2026-01-17', deliveryDate: '2026-01-24' },
    { id: 'SO-1250', customer: 'Egyptian Commerce Group', country: 'Egypt', amount: '₹15,40,000', products: 'Electronics', quantity: 670, status: 'Confirmed', date: '2026-01-10', deliveryDate: '2026-01-17' },
    { id: 'SO-1251', customer: 'Saudi Trading House', country: 'Saudi Arabia', amount: '₹28,70,000', products: 'Machinery', quantity: 920, status: 'Shipped', date: '2026-01-07', deliveryDate: '2026-01-14' },
    { id: 'SO-1252', customer: 'Qatari Business Group', country: 'Qatar', amount: '₹31,50,000', products: 'Electronics', quantity: 1100, status: 'Invoiced', date: '2026-01-08', deliveryDate: '2026-01-15' },
    { id: 'SO-1253', customer: 'Belgian Distributors NV', country: 'Belgium', amount: '₹12,60,000', products: 'Textiles', quantity: 430, status: 'Confirmed', date: '2026-01-15', deliveryDate: '2026-01-22' },
    { id: 'SO-1254', customer: 'Finnish Import Services', country: 'Finland', amount: '₹14,90,000', products: 'Raw Materials', quantity: 580, status: 'Shipped', date: '2026-01-09', deliveryDate: '2026-01-16' },
    { id: 'SO-1255', customer: 'Portuguese Export Group', country: 'Portugal', amount: '₹11,30,000', products: 'Chemicals', quantity: 460, status: 'Draft', date: '2026-01-18', deliveryDate: '2026-01-25' },
    { id: 'SO-1256', customer: 'Mexican Trading House', country: 'Mexico', amount: '₹14,50,000', products: 'Electronics', quantity: 510, status: 'Confirmed', date: '2026-01-13', deliveryDate: '2026-01-20' },
  ])
  ...
  const downloadOrderPDF = (order) => {
    ...
    doc.setFontSize(12)
    doc.text('Export Order Document', 105, 30, { align: 'center' })
    ...
    doc.setFontSize(10)
    doc.text(`Customer: ${order.customer}`, 20, 93)
    doc.text(`Country: ${order.country}`, 20, 100)
    doc.text(`Delivery Date: ${order.deliveryDate}`, 20, 107)
    ...
    doc.save(`Sales_Order_${order.id}.pdf`)
  }

  // Export to CSV
  const exportToCSV = () => {
    const headers = ['Order ID', 'Customer', 'Country', 'Products', 'Quantity', 'Amount', 'Status', 'Date', 'Delivery Date']
